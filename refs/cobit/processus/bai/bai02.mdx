...
| --- | --- |
| Les exigences métier fonctionnelles et techniques reflètent les attentes et les besoins de l’entreprise. | <ul><li>Pourcentage des exigences remaniées en raison d’un mauvaise alignement avec les besoins et les attentes de l’entreprise</li><li>Niveau de satisfaction des parties prenantes en matière d'exigences</li></ul> |
...
| Le risque lié aux exigences a été pris en charge dans la solution proposée. | <ul><li>Nombre d’incidents non considérés comme un risque</li><li>Pourcentage des risques pour lesquels l’atténuation s’est révélée ineffiicace</li></ul> |
