...
| --- | --- |
| L’entreprise peut utiliser efficacement les services informatiques tels que cela est défini dans un catalogue. | <ul><li>Nombre de processus métiers avec des accords de services non définis</li></ul>|
...
| Les services informatiques fonctionnent tels que stipulé dans les accords de services. | <ul><li>Nombre et gravité des défaillances de service</li><li>Pourcentage des services dont les niveaux de services sont surveillés</li><li>Pourcentage des objectifs de services atteints</li></ul>|

## Pratiques

### APO09.01 - Identifier les services informatiques

Analyser les exigences métiers et la façon dont les services informatiques et les niveaux de services servent les processus métiers. Discuter et s’entendre avec les entités métiers quant aux services potentiels et aux niveaux de services, et les comparer avec le portefeuille de services actuel afin d’identifier les services à mettre en œuvre ou à modifier ainsi que les options de niveaux de services.

**Entrées/Sorties**

| **Description** | **Venant de** | **Description** | **Vers** |
| :-- | :--- | :-- | :--- |
|  |  | Lacunes identifiées dans les services informatiques pour les entités métiers | APO02.02 / APO05.03 / APO08.02 |
