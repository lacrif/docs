...
Définir les exigences en terme de taxinomie, normes, directives, procédures, modèles documentaires et outils. 
Fournir un scéma de relation entre ces composants. Améliorer l'ajustement, accroitre l'agilité, améliorer la qualité de l'information et lancer des initiatives permettant des économies potentielles telles que la réutilisation d'ensembles de composants.
