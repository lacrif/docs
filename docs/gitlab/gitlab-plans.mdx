...
Ce guide aide à choisir rapidement entre les offres GitLab (Free, Premium/Team, Ultimate/Enterprise) et entre les modèles de déploiement (SaaS vs On‑Premise). Suivez les étapes ci‑dessous et reportez-vous au tableau comparatif dans [Les offres GitLab (comparatif)](/docs/gitlab/gitlab-plans) pour un résumé visuel.
